...
class SalesforceBulk(object):
    ...
    def __init__(self, sessionId=None, host=None, username=None, password=None,
                 API_version=DEFAULT_API_VERSION, security_token=None,
                 organizationId=None, client_id=None):
        ...
        if not sessionId:
            sessionId, host = SalesforceBulk.login_to_salesforce(
                username, password, security_token=security_token,
    ...
    @staticmethod
    def login_to_salesforce(username, password, security_token=None,
